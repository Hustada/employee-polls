...
A Polling App for Employees. Users can create and vote on one of two questions. Keeps a tally of votes along with a leaderboard. Only specified users are allowed at the time being.
